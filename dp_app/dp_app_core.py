...
def get_data_class(col_name, col_val, mdl_labels):
    ...
    if 'PERSON' in mdl_labels and 'name' in col_name:
        info_type = 'NAME'
        data_class = 'PII'
    elif 'LOC' in mdl_labels and ufm.check_if_any_list_item_in_str(['address', 'addr'], col_name):
        info_type = 'ADDRESS'
        data_class = 'PII'
    elif 'DATE' in mdl_labels and ufm.check_if_any_list_item_in_str(['dob', 'birth'], col_name):
